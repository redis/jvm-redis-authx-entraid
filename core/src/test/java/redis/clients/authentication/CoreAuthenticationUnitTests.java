...
public class CoreAuthenticationUnitTests {
    ...
    public void testCalculateRenewalDelay() {
        ...
        assertThat(delay,
            Matchers.greaterThanOrEqualTo(Math.min(duration - config.lower, (long) (duration * config.ratio))));
    ...
    @Test
    public void testTokenManagerStart() throws InterruptedException, ExecutionException, TimeoutException {
    ...
    @Test
    public void testNoBlockForInitialToken() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        TokenManager tokenManager = new TokenManager(identityProvider,
                new TokenManagerConfig(0.7F, 200, 2000, new TokenManagerConfig.RetryPolicy(numberOfRetries - 1, 100)));
